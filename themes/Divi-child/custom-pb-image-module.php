...
function ex_divi_child_theme_setup() {
  ...
  if ( class_exists('ET_Builder_Module')) {
    ...
    class ET_Builder_Module_Post_Slider_Taris_2 extends ET_Builder_Module {
      function init() {
        $this->name       = esc_html__( 'Post Slider Taris', 'et_builder' );
      ...
      function get_fields() {
        ...
        '__posts' => array(
        'type'                => 'computed',
        'computed_callback'   => array( 'ET_Builder_Module_Post_Slider_Taris', 'get_blog_posts' ),
    ...
    new ET_Builder_Module_Post_Slider_Taris_2;

  }

}
// add_action('ET_Builder_Module_Post_Slider_Taris_2', 'ex_divi_child_theme_setup');
